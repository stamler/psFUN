...
Install:
Quebec East iR-ADV C5550 III 10.191.80.8
powershell.exe -executionpolicy bypass -file .\Install-Printer.ps1 -PortName "IP_10.191.80.8" -PrinterIP "10.191.80.8" -PrinterName "Quebec East Canon iR-ADV C5550 III" -DriverName "Canon Generic Plus UFR II" -INFFile "CNLB0MA64.inf"
Quebec West iR-ADV 4545 10.191.80.14
powershell.exe -executionpolicy bypass -file .\Install-Printer.ps1 -PortName "IP_10.191.80.14" -PrinterIP "10.191.80.14" -PrinterName "Quebec West Canon iR-ADV 4545" -DriverName "Canon Generic Plus UFR II" -INFFile "CNLB0MA64.inf"
Uninstall:
...
Detection:
HKEY_LOCAL_MACHINE\Software\Microsoft\Windows NT\CurrentVersion\Print\Printers\Quebec East Canon iR-ADV C5550 III
HKEY_LOCAL_MACHINE\Software\Microsoft\Windows NT\CurrentVersion\Print\Printers\Quebec West Canon iR-ADV 4545
Name = "Quebec East Canon iR-ADV C5550 III"
Name = "Quebec West Canon iR-ADV 4545"

.Example
.\Install-Printer.ps1 -PortName "IP_10.191.80.8" -PrinterIP "10.191.80.8" -PrinterName "Quebec East Canon iR-ADV C5550 III" -DriverName "Canon Generic Plus UFR II" -INFFile "CNLB0MA64.inf"
#>
